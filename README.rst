...
The internals are similar to ORM type systems, but there is no database layer in Schematics.  Instead, we believe that building a database layer is easilly made when Schematics handles everything except for writing the query.
