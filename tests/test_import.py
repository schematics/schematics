...
def test_import_data(init):
    ...
    m = M({"a": 1, "b": None, "c": 3}, init=init)

    m.import_data({"a": None, "b": 2})
...
@pytest.mark.parametrize(
    "preconvert_source, populate_source", [(False, None), (True, True), (True, False)]
)
@pytest.mark.parametrize(
    "recursive, populate_target, init_to_none, populated_result",
    [
...
def test_complex_import_data(
    ...
    origdict = {
        ...
        "modelfield": {
            ...
            "modelfield": {"intfield": "3", "dictfield": dict(a=111, b=222)},
        },
    }
    ...
    sourcedict = {
        ...
        "modelfield": {
            "matrixfield": [[9]],
            "modelfield": {"intfield": "103", "dictfield": dict(c=33)},
        },
    }
